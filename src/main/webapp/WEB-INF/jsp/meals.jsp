        ...
        <div class="shadow">
            ...
            <form id="filterForm" method="get" action="meals/filter">
                <table>
                    ...
                    <tr>
                        <th><spring:message code="meals.endDate"/></th>
                        <td><input type="date" name="endDate" value="${param.endDate}"></td>
                    </tr>
                    <tr>
                        <th><spring:message code="meals.startTime"/></th>
                        <td><input type="time" name="startTime" value="${param.startTime}"></td>
                    </tr>
                    <tr>
                        <th><spring:message code="meals.endTime"/></th>
            ...
            <a class="btn btn-primary" onclick="add()"><spring:message code="meals.add"/></a>
            <div class="space-height-30px"></div>
                ...
                <form class="form-horizontal" method="post" id="detailsForm">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-3 col-xs-9">
                            <button type="submit" class="btn btn-primary"><spring:message code="meals.add"/></button>
                        </div>
                    </div>
                </form>
            </div>
